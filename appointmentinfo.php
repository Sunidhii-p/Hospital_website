...
<head>
    ...
    <link rel="stylesheet" href="appointmentinfo.css">
...
<header class="main-header">
    <div class="header-left"> <h2> <i class="fa fa-bars"></i> <span> Appointment History</span></h2></div>
...
<div class="main-content-info container">
    <div class="card-box"> <i class="fa fa-calendar  fa-3x"></i> <h2>Appointment History</h2></div>
    <div class="clear"></div>
    <div >
    <table border="3"width="100%"> 
        <tr><th><h4>User_id</h4></th>
            <th><h4>Name</h4></th>
            <th><h4>email</h4></th>
            <th><h4>Phone</h4></th>
    ...
    echo "<tr>
            ...
            <td>".$result['email']."</td>
            <td>".$result['phone']."</td>
            <td>".$result['doctordepartment']."</td>
            <td>".$result['doctorname']."</td>
            <td>".$result['age']."</td>
            <td>".$result['address']."</td>
            <td>".$result['gender']."</td>
            <td>".$result['appointment_date']."</td>
            <td>".$result['consultant_hour']."</td>
            <td><a href=\"appointmentinfodelete.php?use=$result[id]\"><input type='submit'value='Delete'></a></td>
            </tr>";
    }
    }
    else
