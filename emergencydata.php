...
<head>
    ...
    <link rel="stylesheet" href="emergencydata.css">
...
<header class="main-header">
    <div class="header-left"> <h2> <i class="fa fa-bars"></i> <span> Emergency</span></h2></div>
...
<div class="main-content-info container">
    <div class="card-box"> <i class="fa fa-ambulance  fa-3x"></i><h2>Emergency</h2></div>
    <div class="clear"></div>
    <div >
    ...
    echo "<tr>
            ...
            <td><a href=\"deleteemergency.php?use=$result[id]\"><input type='submit'value='Delete'></a></td>
            </tr>";
    }
    }
    else
